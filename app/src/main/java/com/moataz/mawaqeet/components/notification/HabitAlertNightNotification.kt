...
import com.moataz.mawaqeet.components.notification.utils.NotificationConstant.HABIT_ALERT_NIGHT_CHANNEL_ID
...
class HabitAlertNightNotification : BroadcastReceiver() {
    ...
    fun setupHabitAlertNightNotification(context: Context) {
        ...
        if (cal.timeInMillis > System.currentTimeMillis()) {
            val notificationIntent = Intent(context, HabitAlertNightNotification::class.java)
            val broadcast =
